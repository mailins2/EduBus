...
if (document.querySelectorAll('#d-activity').length) {
    const options = {
      series: [{
        name: 'Số học sinh',
        data: [40, 50, 55, 50, 30, 80, 30, 40, 50, 55,10,10,10,10,10,10,10,10,10]
      }],
      chart: {
        type: 'bar',
        height: 230,
      ...
      xaxis: {
        categories: ['Quận 1','Quận 2','Quận 3','Quận 4','Quận 5','Quận 6','Quận 7','Quận 8','Quận 9','Quận 10','Quận 11','Quận 12','Tân Bình','Tân Phú','Phú Nhuận','Bình Tân','Bình Thạnh','Gò Vấp','Thủ Đức'],
        labels: {
          minHeight:20,
          maxHeight:60,
          style: {
