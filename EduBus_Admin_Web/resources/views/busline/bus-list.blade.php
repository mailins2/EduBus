                  ...
                  <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $bus['taixe_id']['hoten'] ?? 'chưa có'}}</td>
                           <td>{{ $bus['lich_trinh']['giobatdau_sang'] ?? 'chưa có'}} - {{ $bus['lich_trinh']['gioketthuc_sang'] ?? 'chưa có'}}</td>
                           <td>{{ $bus['lich_trinh']['giobatdau_chieu'] ?? 'chưa có'}} - {{ $bus['lich_trinh']['gioketthuc_chieu'] ?? 'chưa có'}}</td>
                           <td>
