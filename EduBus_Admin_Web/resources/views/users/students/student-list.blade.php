@extends('layouts.app')
@section('tittle','Danh sách học sinh')
@section('content')
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               ...
               <button type="button" class="btn" style="color:#3a57e8">
                  ...
                  <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $user['hoc_sinh_info']['xe_id'] ?? 'chưa có'}}</td>
                           <td>{{ $user['hoc_sinh_info']['diadiem_don'] ?? 'chưa có'}}</td>
