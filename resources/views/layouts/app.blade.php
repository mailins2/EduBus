...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>@yield('tittle','EduBus')</title>
      <link rel="shortcut icon" href="{{ asset('assets/images/MiniLogo.svg') }}">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="/" class="navbar-brand">
                <h4 class="logo-title" style="font-weight:bold">EduBus</h4>
            </a>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/">
                            ...
                            <span class="item-name">Bảng điều khiển</span>
                        </a>
                    </li>
                    <li><hr class="hr-horizontal"></li>
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Tùy chọn quản lý</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/student-list">
                                    ...
                                    <span class="item-name">Học sinh</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="/driver-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-maps" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/bus-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
              ...
              <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{$admin['profile']['avatar']}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded" style="focus:center">
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">{{ $admin['profile']['hoten'] ?? 'Khách' }}</h6>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  <h1>Hello Admin!</h1>
                                  <p>Chào mừng bạn đến với Hệ Thống Quản Lý EduBus.</p>
                              </div>
                          </div>
                      </div>
                  </div>
