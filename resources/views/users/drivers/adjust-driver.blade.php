   ...
   <div class="row">
      ...
      <div class="col-xl-3 col-lg-4">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{ route('driver-list.update', $student['user']['_id']) }}" id="studentForm" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
      ...
      <div class="col-xl-9 col-lg-8">
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Chỉnh sửa thông tin tài xế</h4>
               </div>
            </div>
            <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                           ...
                           <input id="studentCode" type="text" class="form-control"
                                 value="{{ $student['user']['tai_xe_info']['mabanglai'] ?? '' }}"
                                 name="mabanglai">
                        </div>
